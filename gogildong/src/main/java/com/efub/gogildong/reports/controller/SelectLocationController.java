...
public class SelectLocationController {
    ...
    * */
    ...
    public ResponseEntity<FacilityListResponse> getFacilityListInBuilding(@PathVariable Long floorId, Authentication authentication) {
        return ResponseEntity.ok(selectionLocationService.getFacilityList(authentication.getName(), floorId));
    }
